          ...
          this.setState({
            formData: {
              produto: {
                ...
                nome_comercial: this.props.record.nome_comercial
              },
              ...this.props.record
            }
          });
          ...
          <Form layout="vertical" onChange={this.onHadleChange}>
            ...
            <Form.Item label="Valor da Meta">
              {getFieldDecorator("meta_valor", {
                ...
                initialValue: addMaskReais(this.state.formData.meta_valor),
            ...
            <Form.Item label="Valor da Meta Reais">
              {getFieldDecorator("meta_valor_reais", {
                ...
                //   { required: true, message: "Este campo é obrigatório!" }
                // ],
                initialValue: addMaskReais(this.state.formData.meta_valor_reais),
                getValueFromEvent: e => addMaskReais(e.target.value),
                onChange: e => {
                  e.persist();
                  e.target
